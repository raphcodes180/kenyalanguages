...
import kikuyuData from '../data/kikuyuData';

function KikuyuDictionary() {
  const [searchTerm, setSearchTerm] = useState('');

  const filteredData = kikuyuData.filter(
    (item) =>
      ...
      <Card sx={{ mb: 4, p: 2, boxShadow: 3 }}>
        <CardContent>
          ...
          <Typography variant="body1" align="center" sx={{ mb: 3 }}>
            Explore Kikuyu words and their English translations. Search for
            specific terms or browse the dictionary to expand your vocabulary.
          </Typography>

          <TextField
            fullWidth
            label="Search Kikuyu or English"
            variant="outlined"
            value={searchTerm}
...
export default KikuyuDictionary;
